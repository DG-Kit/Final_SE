...
namespace FinalProject.Areas.Admin.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ManufacturerId,ManufacturerName,ManufacturerYear")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ManufacturerId,ManufacturerName,ManufacturerYear")] Manufacturer manufacturer)
        {
            if (ModelState.IsValid)
            {
